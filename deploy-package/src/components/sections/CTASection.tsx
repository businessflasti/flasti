...
const CTASection = () => {
  ...
  return (
    <section className="py-12 relative overflow-hidden">
      {/* Fondo con efecto de gradiente ELIMINADO */}
      ...
      <div className="container-custom relative z-10">
        <div className="glass-card border border-white/10 rounded-2xl p-6 max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4 max-w-3xl mx-auto mt-6">
            <div className="glass-card p-3 rounded-xl border border-white/10 hover:border-[#3c66ce]/30 transition-all hover:shadow-lg hover:shadow-[#3c66ce]/5 text-center">
