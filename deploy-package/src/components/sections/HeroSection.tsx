      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-row justify-center gap-4 sm:gap-8 mb-10 mt-8 animate-entry animate-entry-delay-3 hardware-accelerated hero-stats-container">
            <div className="bg-card/40 backdrop-blur-sm border border-white/5 rounded-xl px-2 sm:px-6 py-2 sm:py-4 text-center flex-1">
              <p className="text-lg sm:text-3xl font-bold mb-1 sm:mb-2 text-[#4CAF50] flex justify-center">
            ...
            <div className="bg-card/40 backdrop-blur-sm border border-white/5 rounded-xl px-2 sm:px-6 py-2 sm:py-4 text-center flex-1">
              <p className="text-lg sm:text-3xl font-bold mb-1 sm:mb-2 text-[#facc15] flex justify-center">
                <AnimatedCounter value={stats.microtasksCompleted} />
              </p>
              <p className="text-[10px] sm:text-sm text-foreground/60 whitespace-normal">{t('microtrabajosCompletados')}</p>
            </div>
          </div>
