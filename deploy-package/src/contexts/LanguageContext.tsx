...
export const translations = {
  es: {
    ...
    descuento: '90% OFF',
    ofertaTermina: '¡La oferta con 90% OFF termina en:',
  ...
  en: {
    ...
    descuento: '90% OFF',
    ofertaTermina: 'The 90% OFF offer ends in:',
  ...
  'pt-br': {
    ...
    descuento: '90% OFF',
    ofertaTermina: 'A oferta com 90% OFF termina em:',
