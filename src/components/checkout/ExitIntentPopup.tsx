...
const ExitIntentPopup = ({ isOpen, onClose, onApplyCoupon, onApplyFinalDiscount, isArgentina = false }: ExitIntentPopupProps) => {
  ...
  return (
    <div ref={containerRef}>
      ...
      >
        <DialogContent
          className={`sm:max-w-md border border-[#2a2a4a] bg-gradient-to-b from-[#1a1a2e] to-[#141428] text-white p-0 overflow-hidden shadow-xl animate-in fade-in-0 zoom-in-95 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:duration-500 data-[state=closed]:duration-300 ${
            showConfirmation ? 'max-w-sm mx-auto' : ''
          }`}
            ...
            <>
              ...
              <DialogHeader className="pb-3">
                <div className="flex justify-center mb-2">
                  <div className="inline-block p-2 rounded-full bg-gradient-to-br from-[#ef4444]/20 to-[#f97316]/20 border border-[#ef4444]/30">
                    <HelpCircle className="h-6 w-6 text-[#ef4444]" />
                  </div>
                </div>
                <DialogTitle className="text-xl sm:text-2xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white/80">
                  ¿Estás seguro?
                </DialogTitle>
                <p className="text-center text-white/70 mt-0.5 text-xs">
                  Estás a punto de perder esta oportunidad
                </p>
              </DialogHeader>

              <div className="space-y-4 relative">
                <div className="bg-gradient-to-r from-[#ef4444]/20 to-[#f97316]/20 p-4 rounded-lg border border-[#ef4444]/30 shadow-sm shadow-[#ef4444]/20">
                ...
                <p className="text-sm text-white text-center mt-2 font-medium tracking-normal">
                ...
                <div className="flex flex-col gap-2 mt-4">
                  <Button
                    ...
                    className="w-full py-3 text-sm font-bold bg-gradient-to-r from-[#22c55e] to-[#16a34a] hover:from-[#16a34a] hover:to-[#15803d] border-0 shadow-lg shadow-[#22c55e]/20 flex items-center justify-center gap-2"
                  >
                  ...
                  <Button
                    ...
                    className="w-full py-3 text-sm font-bold bg-gradient-to-r from-[#475569]/80 to-[#334155]/80 hover:from-[#475569] hover:to-[#334155] border-0 shadow-lg shadow-[#475569]/10 flex items-center justify-center"
                  >
            ...
            <>
              <DialogHeader className="pb-4">
                <div className="flex justify-center mb-2">
                  {showFinalOffer ? (
                    ...
                    <div className="inline-block p-3 rounded-full bg-gradient-to-br from-[#9333ea]/20 to-[#ec4899]/20 border border-[#ec4899]/30">
                      <Gift className="h-8 w-8 text-[#ec4899]" />
                    </div>
                  )}
                </div>
              ...
              <div className="mt-6 flex justify-center">
                <Button
                  ...
                  className={`w-full max-w-md py-6 text-base font-bold border-0 shadow-lg flex items-center justify-center gap-2 transition-all ${
