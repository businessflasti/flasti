...
const ExitIntentPopup = ({ isOpen, onClose, onApplyCoupon, onApplyFinalDiscount, isArgentina = false }: ExitIntentPopupProps) => {
  ...
  return (
    <div ref={containerRef}>
      ...
      >
        <DialogContent
          className={`sm:max-w-md border border-[#2a2a4a] bg-gradient-to-b from-[#1a1a2e] to-[#141428] text-white p-0 overflow-hidden shadow-xl animate-in fade-in-0 zoom-in-95 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:duration-500 data-[state=closed]:duration-300 mx-4 ${
