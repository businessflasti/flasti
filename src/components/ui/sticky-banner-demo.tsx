...
export function StickyBannerDemo({
  message = "¡Cerrá julio ganando más! Descubrí las novedades y aprovechá al máximo",
  linkText = "Ver más",
  linkHref = "#"
    ...
    return (
      <StickyBanner className="bg-[#3C66CD]">
        <p className="mx-0 text-sm sm:text-base text-white drop-shadow-md leading-relaxed pr-8">
          <span className="font-bold">¡Cerrá julio ganando más!</span> Descubrí las novedades y aprovechá al máximo
        </p>
      </StickyBanner>
    );
  } catch (error) {
