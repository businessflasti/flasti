        ...
        {imageUrl ? (
          <img 
            ...
            style={{ 
              ...
              height: '100%', 
              objectFit: 'cover',
              objectPosition: name === "Sin experiencia" ? "top center" : "center",
      ...
      <div className="card__avatar">
        {icon || (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
            ...
            <path fill="#7f3838" d="m64 14a32 32 0 0 1 32 32v41a6 6 0 0 1 -6 6h-52a6 6 0 0 1 -6-6v-41a32 32 0 0 1 32-32z" />
            <path opacity=".4" fill="#393c54" d="m62.73 22h2.54a23.73 23.73 0 0 1 23.73 23.73v42.82a4.45 4.45 0 0 1 -4.45 4.45h-41.1a4.45 4.45 0 0 1 -4.45-4.45v-42.82a23.73 23.73 0 0 1 23.73-23.73z" />
            ...
            <path fill="#bc5b57" d="m91.49 51.12v-4.72c0-14.95-11.71-27.61-26.66-28a27.51 27.51 0 0 0 -28.32 27.42v5.33a2 2 0 0 0 2 2h6.81a8 8 0 0 0 6.5-3.33l4.94-6.88a18.45 18.45 0 0 1 1.37 1.63 22.84 22.84 0 0 0 17.87 8.58h13.45a2 2 0 0 0 2.04-2.03z" />
            <path style={{fill: 'none', strokeLinecap: 'round', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: 2, opacity: '.1'}} d="m62.76 36.94c4.24 8.74 10.71 10.21 16.09 10.21h5" />
            <path style={{fill: 'none', strokeLinecap: 'round', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: 2, opacity: '.1'}} d="m71 35c2.52 5.22 6.39 6.09 9.6 6.09h3" />
