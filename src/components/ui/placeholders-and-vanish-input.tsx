...
export function PlaceholdersAndVanishInput({
  ...
  }, [placeholders.length]); // Solo depende de placeholders.length para evitar re-renders innecesarios
      ...
      <div className="absolute inset-0 flex items-center justify-center rounded-full pointer-events-none">
        <AnimatePresence mode="wait">
          <motion.p
            ...
            className="text-xs sm:text-sm md:text-base font-normal text-center w-full truncate px-2"
            style={{ color: '#aeaeb0' }}
          >
