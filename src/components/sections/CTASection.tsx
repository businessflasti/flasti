...
const CTASection = () => {
  ...
  return (
    <section className="py-12 relative overflow-hidden">
      {/* Overlays decorativos de diferentes colores */}
      ...
      <div className="container-custom relative z-10">
        <div className="bg-card/30 backdrop-blur-md shadow-xl border border-white/10 rounded-2xl p-6 max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4 max-w-3xl mx-auto mt-6">
            <div className="bg-card/30 backdrop-blur-md shadow-xl p-3 rounded-xl border border-white/10 hover:border-[#d4386c]/30 transition-all hover:shadow-lg hover:shadow-[#d4386c]/5 text-center group">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#d4386c]/20 to-[#3359b6]/20 flex items-center justify-center mx-auto mb-2 border border-white/10">
                <Shield className="text-[#d4386c] h-4 w-4" />
              </div>
            ...
            <div className="bg-card/30 backdrop-blur-md shadow-xl p-3 rounded-xl border border-white/10 hover:border-[#d4386c]/30 transition-all hover:shadow-lg hover:shadow-[#d4386c]/5 text-center group">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#d4386c]/20 to-[#3359b6]/20 flex items-center justify-center mx-auto mb-2 border border-white/10">
                <Lightbulb className="text-[#d4386c] h-4 w-4" />
              </div>
            ...
            <div className="bg-card/30 backdrop-blur-md shadow-xl p-3 rounded-xl border border-white/10 hover:border-[#d4386c]/30 transition-all hover:shadow-lg hover:shadow-[#d4386c]/5 text-center group">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#d4386c]/20 to-[#3359b6]/20 flex items-center justify-center mx-auto mb-2 border border-white/10">
                <Lock className="text-[#d4386c] h-4 w-4" />
              </div>
            ...
            <div className="bg-card/30 backdrop-blur-md shadow-xl p-3 rounded-xl border border-white/10 hover:border-[#d4386c]/30 transition-all hover:shadow-lg hover:shadow-[#d4386c]/5 text-center group">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#d4386c]/20 to-[#3359b6]/20 flex items-center justify-center mx-auto mb-2 border border-white/10">
                <TrendingUp className="text-[#d4386c] h-4 w-4" />
              </div>
            ...
            <div className="bg-card/30 backdrop-blur-md shadow-xl p-3 rounded-xl border border-white/10 hover:border-[#d4386c]/30 transition-all hover:shadow-lg hover:shadow-[#d4386c]/5 text-center group">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#d4386c]/20 to-[#3359b6]/20 flex items-center justify-center mx-auto mb-2 border border-white/10">
                <Target className="text-[#d4386c] h-4 w-4" />
              </div>
            ...
            <div className="bg-card/30 backdrop-blur-md shadow-xl p-3 rounded-xl border border-white/10 hover:border-[#d4386c]/30 transition-all hover:shadow-lg hover:shadow-[#d4386c]/5 text-center group">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#d4386c]/20 to-[#3359b6]/20 flex items-center justify-center mx-auto mb-2 border border-white/10">
                <Rocket className="text-[#d4386c] h-4 w-4" />
              </div>
