...
function StudiovaHeroSection() {
    ...
    return (
        <ParallaxProvider>
            <section className="relative flex items-start text-white bg-black h-full min-h-[70vh] pt-8 overflow-hidden">
                ...
                <div className="relative z-10 container">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start min-h-[60vh] py-6 lg:py-12">
                        ...
                        <div className="flex flex-col gap-10 text-center lg:text-left">
                            ...
                            <div className="hidden lg:flex justify-start pt-4">
                                <button
                                    ...
                                    className="force-segoe-display group relative overflow-hidden bg-gradient-to-r from-white to-gray-50 text-black px-8 py-4 rounded-3xl text-lg font-semibold transition-all duration-300 shadow-xl transform hover:scale-105"
                                >
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/20 via-yellow-300/10 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 animate-shimmer"></div>
                                </button>
                            </div>
                            ...
                            <div className="lg:hidden relative pt-8 h-80">
                                ...
                                <div className="absolute top-20 right-4 bg-gradient-to-br from-[#0B0F17] to-[#0B0F17] rounded-3xl p-4 max-w-xs shadow-2xl animate-float-card" style={{ animationDelay: '0.5s' }}>
                                ...
                                <div className="absolute top-36 right-6 bg-gradient-to-br from-[#FAD74A] to-[#f5c71a] backdrop-blur-2xl rounded-3xl p-3 shadow-xl animate-float-card" style={{ animationDelay: '1s' }}>
                        ...
                        <div className="hidden lg:block relative h-full">
                            ...
                            <div className="absolute top-16 right-12 bg-white rounded-3xl p-6 max-w-sm shadow-2xl animate-float-card transition-all duration-300">
                            ...
                            <div className="absolute top-48 right-40 bg-gradient-to-br from-[#0B0F17] to-[#0B0F17] rounded-3xl p-6 max-w-sm shadow-2xl animate-float-card transition-all duration-300" style={{ animationDelay: '0.5s' }}>
                                <div className="flex items-center gap-4 mb-4">
                            ...
                            <div className="absolute bottom-20 right-8 bg-gradient-to-br from-[#FAD74A] to-[#f5c71a] backdrop-blur-2xl border-2 border-yellow-500/40 rounded-3xl p-4 shadow-xl animate-float-card hover:border-yellow-500/60 transition-all duration-300" style={{ animationDelay: '1s' }}>
                                <div className="text-center relative">
