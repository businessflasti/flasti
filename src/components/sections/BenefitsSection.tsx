        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto animate-on-visible text-left">
          ...
          <Card className="flex flex-col items-start bg-[#232323] border border-white/10 rounded-3xl overflow-hidden shadow-lg p-0 max-w-[350px] mx-auto">
            <div className="w-full h-48 bg-[#232323] overflow-hidden rounded-t-3xl">
              <Image src="/promos/ben1min.jpg" alt="Gana dinero" width={350} height={192} className="object-cover object-top w-full h-full rounded-t-3xl" priority={true} placeholder="blur" blurDataURL="/promos/ben1min.jpg" />
            </div>
          ...
          <Card className="flex flex-col items-start bg-[#232323] border border-white/10 rounded-3xl overflow-hidden shadow-lg p-0 max-w-[350px] mx-auto">
            <div className="w-full h-48 bg-[#232323] overflow-hidden rounded-t-3xl">
              <Image src="/promos/ben2min.jpg" alt="Sin experiencia" width={350} height={192} className="object-cover object-top w-full h-full rounded-t-3xl" priority={true} placeholder="blur" blurDataURL="/promos/ben2min.jpg" />
            </div>
            <div className="flex-1 flex flex-col items-start justify-center p-5 w-full">
          ...
          <Card className="flex flex-col items-start bg-[#232323] border border-white/10 rounded-3xl overflow-hidden shadow-lg p-0 max-w-[350px] mx-auto">
            <div className="w-full h-48 bg-[#232323] overflow-hidden rounded-t-3xl">
              <Image src="/promos/ben3min.jpg" alt="Desde casa" width={350} height={192} className="object-cover object-top w-full h-full rounded-t-3xl" priority={true} placeholder="blur" blurDataURL="/promos/ben3min.jpg" />
            </div>
            <div className="flex-1 flex flex-col items-start justify-center p-5 w-full">
          ...
          <Card className="flex flex-col items-start bg-[#232323] border border-white/10 rounded-3xl overflow-hidden shadow-lg p-0 max-w-[350px] mx-auto">
            <div className="w-full h-48 bg-[#232323] overflow-hidden rounded-t-3xl">
              <Image src="/promos/ben4min.jpg" alt="Sin horarios" width={350} height={192} className="object-cover object-top w-full h-full rounded-t-3xl" priority={true} placeholder="blur" blurDataURL="/promos/ben4min.jpg" />
            </div>
            <div className="flex-1 flex flex-col items-start justify-center p-5 w-full">
