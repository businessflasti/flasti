      ...
      <div className="container-custom">
        <div className="flex items-center justify-between py-3.5">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a
              href="/register"
              className="text-black px-4 py-2 rounded-lg transition-colors duration-200 font-medium text-sm"
          ...
          <div className="flex md:hidden items-center gap-3">
            ...
            <a
              href="/register"
              className="text-black px-3 py-2 rounded-lg transition-colors duration-200 font-medium text-sm"
              style={{ backgroundColor: '#F6F3F3' }}
            >
              Regístrate
            </a>
