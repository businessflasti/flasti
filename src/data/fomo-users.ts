// Datos de usuarios para notificaciones FOMO
...
// Exportar todos los usuarios para compatibilidad con código existente
export const allUsers: FomoUser[] = Object.values(usersByCountry).flat();
