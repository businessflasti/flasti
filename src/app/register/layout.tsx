...
export const metadata: Metadata = {
  ...
  description: "Regístrate gratis en Flasti y comienza a ganar dinero completando microtareas en línea. Sin experiencia previa. Únete a más de 100K usuarios. Gana de $1 a $20 USD por tarea.",
