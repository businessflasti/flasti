      ...
      >
        <div className="container-custom py-16 md:py-24">
          <div className="max-w-3xl mx-auto">
            ...
            >
              <div className="prose prose-lg max-w-none" style={{ color: '#6B7280' }}>
                <p>
                ...
                <p>
                  Algunas funciones de Flasti requieren crear una cuenta. Si lo hacés:
                </p>
                <ul className="space-y-3 mt-4">
                  <li>Asegurate de proporcionar datos válidos.</li>
                  <li>Te avisaremos si hay cambios en las condiciones.</li>
