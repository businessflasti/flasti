    ...
    <MainLayout showHeader={true} disableChat={true}>
      <Suspense fallback={<div className="container-custom py-16 md:py-24">Cargando...</div>}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
          <div className="p-8 rounded-2xl transition-all duration-300 relative overflow-hidden" style={{backgroundColor: '#232323'}}>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-xl transition-all duration-300" style={{backgroundColor: '#232323'}}>
