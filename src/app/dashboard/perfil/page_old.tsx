...
import { Shield, Mail, Phone, Calendar, User, Camera } from 'lucide-react';
        ...
        <Card className="p-6 bg-card/60 backdrop-blur-md border-border/40 md:col-span-1">
          ...
          <div className="flex flex-col items-center justify-center py-4">
            ...
            <div className="relative mb-4">
              <div className="h-28 w-28 rounded-full overflow-hidden border-4 border-background shadow-lg bg-primary/20 flex items-center justify-center">
                {userData?.avatar_url ? (
                  <img
