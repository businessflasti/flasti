...
export const translations = {
  es: {
    ...
    faq3Answer: "Aquí es donde entras tú. Tienes el control total: puedes generar un ingreso estable para tu día a día o simplemente ganar un extra en tu tiempo libre.\n\n• Elige cómo y cuánto ganar\n\nCompleta microtareas de corto, mediano o largo plazo según tu tiempo disponible y cuánto dinero quieras generar. Tú decides hasta dónde llegar. Elige tu camino y empieza a ganar.",
