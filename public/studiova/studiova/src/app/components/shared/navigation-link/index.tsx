...
const NavigationLink = (props: { navigationTitle: string, navigationLink: string , transform: boolean, disabled?: boolean }) => {
    const { navigationTitle, navigationLink ,transform, disabled } = props;
    // Si el título es 'Who we are', mostrar un botón deshabilitado
    if (disabled) {
        return (
            <button
                type="button"
            ...
            >
                <span className="pl-6 text-lg font-bold text-secondary">{navigationTitle}</span>
